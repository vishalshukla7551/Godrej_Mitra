...
export default function ZSMPage() {
  ...
  const cards = [
    { title: 'View Reports', description: 'Check your stores performance', href: '/ZSM/report', color: 'blue' as const, icon: <ReportIcon /> },
    { title: 'Store Settings', description: 'Manage your store configuration', href: '/ZSM/profile', color: 'orange' as const, icon: <SettingsIcon /> },
  ];
