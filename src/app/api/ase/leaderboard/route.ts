 ...
 * Returns top stores, devices, plans for ASE's assigned stores only
...
export async function GET(req: NextRequest) {
  try {
    ...
    // Get active campaigns for ASE's assigned stores only
    ...
    // Get sales reports for ASE's assigned stores within the period
    ...
    console.error('Error in GET /api/ase/leaderboard', error);
    return NextResponse.json(
