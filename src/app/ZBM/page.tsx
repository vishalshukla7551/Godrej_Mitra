    ...
    <div className="flex-1 relative overflow-hidden bg-gray-900">
      ...
      <section className="mt-12 px-10 pb-10">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3 max-w-4xl">
          ...
          <Link href="/ZBM/wallet" className="relative h-60 rounded-2xl border border-zinc-100 bg-white shadow-[0_6px_24px_rgba(0,0,0,0.12)] p-6 block hover:shadow-[0_8px_32px_rgba(0,0,0,0.16)] transition-shadow cursor-pointer">
          ...
          {/* View Reports card */}
          <Link href="/ZBM/report" className="relative h-60 rounded-2xl border border-zinc-100 bg-white shadow-[0_6px_24px_rgba(0,0,0,0.12)] p-6 block hover:shadow-[0_8px_32px_rgba(0,0,0,0.16)] transition-shadow cursor-pointer">
            {/* Arrow button - top right */}
          ...
          {/* Store Settings card */}
          <Link href="/ZBM/profile" className="relative h-60 rounded-2xl border border-zinc-100 bg-white shadow-[0_6px_24px_rgba(0,0,0,0.12)] p-6 block hover:shadow-[0_8px_32px_rgba(0,0,0,0.16)] transition-shadow cursor-pointer">
            {/* Arrow button - top right */}
